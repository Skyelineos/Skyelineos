// Shared types for the Skyeline Homes SMS Agent (Phase 1).
//
...
//
// This file is the single source of truth for the TypeScript types that
// both the server (functions/) and client (client/src) import — keep them
// runtime-agnostic.

...
async function executeAward(
  ...
  // Channels/templates for 'bid_awarded' (audience: sub) are admin-editable in
  // Settings → Notifications; defaults force SMS on this transactional event
  // (STOP/opt-out still honored).
